...
Elm.Teaching.make = function (_elm) {
   ...
   var area = function () {
      var imgArea = $Bootstrap.image($Style.teachingImgArea)(A2($Basics._op["++"],
      $Paths.resources,
      "metrovan.fw.png"));
      return A2($Html.div,
      _L.fromArray([]),
      _L.fromArray([A2($Bootstrap.pageHeader,
                   $Style.teachingAreaHeader,
                   "Location")
                   ,A2($Html.div,
                   _L.fromArray([$Html$Attributes.$class("row")]),
