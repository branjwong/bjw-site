...
Elm.Writing = Elm.Writing || {};
Elm.Writing.make = function (_elm) {
   "use strict";
   _elm.Writing = _elm.Writing || {};
   if (_elm.Writing.values)
   return _elm.Writing.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   var view = function (model) {
      return A2($Html.div,
      _L.fromArray([]),
      _L.fromArray([A3($WritingLibrary.writing,
      model,
      links,
      content)]));
   };
