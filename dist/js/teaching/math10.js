...
Elm.MathTen = Elm.MathTen || {};
Elm.MathTen.make = function (_elm) {
   "use strict";
   _elm.MathTen = _elm.MathTen || {};
   if (_elm.MathTen.values)
   return _elm.MathTen.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
