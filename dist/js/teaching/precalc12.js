...
Elm.PrecalcTwelve = Elm.PrecalcTwelve || {};
Elm.PrecalcTwelve.make = function (_elm) {
   "use strict";
   _elm.PrecalcTwelve = _elm.PrecalcTwelve || {};
   if (_elm.PrecalcTwelve.values)
   return _elm.PrecalcTwelve.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "PrecalcTwelve",
   $Basics = Elm.Basics.make(_elm),
   ...
   tytle,
   " | BJW"));
   _elm.PrecalcTwelve.values = {_op: _op
                               ,tytle: tytle
                               ,main: main
