...
Elm.PhysEleven = Elm.PhysEleven || {};
Elm.PhysEleven.make = function (_elm) {
   "use strict";
   _elm.PhysEleven = _elm.PhysEleven || {};
   if (_elm.PhysEleven.values)
   return _elm.PhysEleven.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "PhysEleven",
   $Basics = Elm.Basics.make(_elm),
   ...
   tytle,
   " | BJW"));
   _elm.PhysEleven.values = {_op: _op
                            ,tytle: tytle
                            ,main: main
