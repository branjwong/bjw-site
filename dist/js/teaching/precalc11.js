...
Elm.PrecalcEleven = Elm.PrecalcEleven || {};
Elm.PrecalcEleven.make = function (_elm) {
   "use strict";
   _elm.PrecalcEleven = _elm.PrecalcEleven || {};
   if (_elm.PrecalcEleven.values)
   return _elm.PrecalcEleven.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "PrecalcEleven",
   $Basics = Elm.Basics.make(_elm),
   ...
   tytle,
   " | BJW"));
   _elm.PrecalcEleven.values = {_op: _op
                               ,tytle: tytle
                               ,main: main
