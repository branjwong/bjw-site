...
Elm.PhysTwelve = Elm.PhysTwelve || {};
Elm.PhysTwelve.make = function (_elm) {
   "use strict";
   _elm.PhysTwelve = _elm.PhysTwelve || {};
   if (_elm.PhysTwelve.values)
   return _elm.PhysTwelve.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "PhysTwelve",
   $Basics = Elm.Basics.make(_elm),
   ...
   tytle,
   " | BJW"));
   _elm.PhysTwelve.values = {_op: _op
                            ,tytle: tytle
                            ,main: main
