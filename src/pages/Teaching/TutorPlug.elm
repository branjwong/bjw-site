module Teaching.TutorPlug exposing (..)
...
* [Foundations of Mathematics and Pre-calculus 10](/#teaching/tutor/math10)
* [Foundations of Mathematics 11](/#teaching/tutor/math11)
* [Pre-calculus 11](/#teaching/tutor/precalc11)
* [Pre-calculus 12](/#teaching/tutor/precalc12)
* [Physics 11](/#teaching/tutor/physics11)
* [Physics 12](/#teaching/tutor/physics12)
* [Japanese](/#teaching/tutor/japanese)
...
area =
    let
        imgArea =
            Bootstrap.image ("/resources/pages/teaching/metrovan.png")
...
foundations =
    ...
    , image = ""
    , content =
        "I make sure to assess and teach what students are missing so that they can return better prepared to the concepts at hand."
...
approaches =
    ...
    , image = ""
    , content =
        "Not all students learn the same way. I make sure that students understand all aspects of concept so that it can be approached confidently."
...
personable =
    ...
    , image = ""
    , content =
        "I am able to relate to students of all age groups. I am diverse in interests, so I can always ensure that I can connect to my students on some level."
