module Writing.WhatIAmDoingWithMyLife exposing (view)
...
takenout =
    "Game development, while cool, is not an industry that I think would be as fulfilling to me in that regard as web or native application development."
