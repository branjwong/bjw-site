...
tytle = .title Teaching.Helper.precalc11
...
main = 
 div
    ...
    , NavBar.navBar "" []
    , NavBar.navBarSpace
    , Header.header "Default" "Learning Outcomes" (.title Teaching.Helper.precalc11) 
    , subjectInfo
    , Footer.footer
    ]
...
subjectInfo =
  div
    ...
    [ div
      [ class "row" ]
      [ Markdown.toHtml (.learningOutcome Teaching.Helper.precalc11) ]
    ]
